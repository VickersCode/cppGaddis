/*
Write a program that determines which of a company's four divisions (Northeast, Southeast, Northwest, and Southwest) had the greatest sales of a quarter. It should include the following two functions, which are called by main:
...
Input Validation: Do not accept anything less than $0.00
*/
